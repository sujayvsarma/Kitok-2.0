...
<div class="kitok2-page mt-2">
    <div class="content">
        <div class="kitok2-webpart content">
            ...
            ?>
                    <div class="card-deck">
                        <div class="card mt-3" style="width: 320px !important; margin-right: 30px !important; margin-top: 30px !important;">
...
<?php
        ...
        <div class="alert alert-secondary" role="alert">
            <span class="glyphicon glyphicon-info-sign" style="font-size: larger;"></span>Looks like there are no books at this time. Do check back later!
        </div>
        <?php
    }
